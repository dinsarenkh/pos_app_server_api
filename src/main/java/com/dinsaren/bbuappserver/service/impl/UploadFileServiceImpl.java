...
import com.dinsaren.bbuappserver.repository.FileImageDetailRepository;
...
public class UploadFileServiceImpl implements UploadFileService {
    ...
    public UploadImageRes uploadFile(MultipartFile files) {
        ...
        try {
            ...
            if (!files.isEmpty()) {
                ...
                fileImageDetail.setStatus(Constants.ACTIVE_STATUS);
    ...
    public FileImageDetail findImageByFileName(String filename) {
        return fileImageDetailRepository.findByFileNameAndStatus(filename, Constants.ACTIVE_STATUS);
    }
